...
const Search = ():JSX.Element =>{
    ...
    return(
        <div className="flex border-b p-2 w-2/4 relative" ref={searchRef}>
           <svg
            ...
            {isDropdownVisible && (
                <ul
                    tabIndex={0}
                    className="dropdown-menu absolute left-0 top-full mt-1 bg-gray-800 z-[1] w-full max-h-40 overflow-y-auto shadow-lg"
                >
